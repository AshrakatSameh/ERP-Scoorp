...
import { ChangeDetectorRef, Component, ElementRef, OnInit, Renderer2, ViewChild, NgZone } from '@angular/core';
...
,private itemService : ItemsService, private renderer:Renderer2,private cdr: ChangeDetectorRef,private ngZone:NgZone
